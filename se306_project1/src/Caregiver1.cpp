...
std::string originName = "Caregiver1Origin";
...
void Caregiver1::delegate(se306_project1::ResidentMsg msg)
{
	/*if (msg.state == 'care') {
		if (!atResident) {
...
*/
bool Caregiver1::shower(se306_project1::ResidentMsg msg) {
...
*	@return Returns true if behaviour was successful, and false otherwise.
*/
bool Caregiver1::exercise(se306_project1::ResidentMsg msg) {
...
*/
int Caregiver1::run(int argc, char *argv[])
{
	/* -- Initialisation -- */
	
	//You must call ros::init() first of all. ros::init() function needs to see argc and argv. The third argument is the name of the node
	ros::init(argc, argv, "Caregiver1");
	...
	ros::Subscriber StageOdo_sub = n.subscribe<nav_msgs::Odometry>("robot_0/odom",1000, &Caregiver1::StageOdom_callback,dynamic_cast<Agent*>(this));

	//custom Resident subscriber to "resident/state"
	ros::Subscriber resident_sub = n.subscribe<se306_project1::ResidentMsg>("residentStatus",1000,&Caregiver1::delegate, this);
...
int main(int argc, char *argv[]) {
	Caregiver1 *a = new Caregiver1();
	a->Caregiver1::run(argc, argv);
}
