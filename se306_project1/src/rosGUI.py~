...
class simpleapp_tk(Tkinter.Tk):
	...
	def initialize(self):
		...
		# Health Bar (Parent)
		healthBar = Tkinter.Canvas(statusFrame, bg="blue", height=16, width=200, highlightbackground="black")
		healthBar.grid(column=1, row=1, sticky="E", padx=3)
        # Health Bar (Filler)
		healthFiller = healthBar.create_rectangle(0,0,50,100, fill="red") #Change 3rd argument to alternate health level
        
        # Hunger Bar (Parent)
		hungerBar = Tkinter.Canvas(statusFrame, bg="blue", height=16, width=200, highlightbackground="black")
		hungerBar.grid(column=1, row=2, sticky="E", padx=3)
        # Hunger Bar (Filler)
		hungerFiller = hungerBar.create_rectangle(0,0,50,100, fill="red") #Change 3rd argument to alternate hunger level
		...
		timeText = Tkinter.Label(timeFrame, text="Current Time : ")
		timeText.grid(column=0, row=0)
        
		currentTime = Tkinter.Label(timeFrame, text="11:08PM, 27 August 2014")
		currentTime.grid(column=1, row=0, sticky="E", padx=5)
