...
*/
void Assistant1::medicate(se306_project1::ResidentMsg msg) {
...
*/
void Assistant1::cook(se306_project1::ResidentMsg msg) {
...
*/
void Assistant1::entertain(se306_project1::ResidentMsg msg) {
...
*/
void Assistant1::delegate(se306_project1::ResidentMsg msg) {
...
int Assistant1::run(int argc, char **argv)
{
	...
	ros::Subscriber residentSub = n.subscribe("residentStatus",1000, &Assistant1::delegate, this);
