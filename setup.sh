...
export ROS_WORKSPACE=/afs/ec.auckland.ac.nz/users/d/k/dkim930/unixhome/se306-project1
...
export ROS_PACKAGE_PATH=$ROS_PACKAGE_PATH:/afs/ec.auckland.ac.nz/users/d/k/dkim930/unixhome/se306-project1
