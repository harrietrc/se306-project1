...
export ROS_WORKSPACE=/afs/ec.auckland.ac.nz/users/s/k/skan729/unixhome/se306-project1
...
export ROS_PACKAGE_PATH=$ROS_PACKAGE_PATH:/afs/ec.auckland.ac.nz/users/s/k/skan729/unixhome/se306-project1
